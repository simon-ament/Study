...
| --------------- | --------------------------------- | -------------------------------------------- | ----------------------------------------------------- |
| **Eine Partei** | Einparteien-Minderheitsregierungq | Einparteien-Mehrheitsregierung               |                                                       |
...
![[Screenshot from 2025-06-22 11-11-01.png|500]]
...
1. **"formale" Minderheitsregierungen:** hat feste Unterstützungspartner vorab mit entsprechenden Abkommen ausgehandelt
	- Unterstützungspartei erhält aber keine Ministerposten
	- regieren im Extremfall als "versteckte" Mehrheitsregierungen
	- *Sachen-Anhalt 1994 - 2002 ("Magdeburger Modell")*
...
Eine Minderheitsregierung kann leichter regieren, wenn $\dots$
...
- In Neuseeland sogar "support party ministers":
	...
	- *2005 - 2008:* Unterstützer-Partei (NZ First) stellte den Außenminister, der aber nicht Teil des Kabinetts war, sonder sich bilateral mit der Premierministerin traf

## Gründe für übergroße Koalitionen
*Viele unterschiedliche Gründe, je nach Land und Kontext*

- Axelrod: zusätzliche Partei erhöht die ideologische Spannweiter der Koalition nicht
...
- Kleiner Koalitionspartner ausbalancieren oder gegeneinander ausspielen
...
- In erstaunlichem Maße bestätigt: Studien finden Proportionalitätswerte von bis zu $0,9$ (auf einer Skala zwischen $0$ und $1$)
	- Die "Formateur"-Partei kann sich also in parlamentarischen Systemen keine Vorteil bei der Ministerienverteilung verschaffen
	- **Aber:** kleine Parteien liegen eher über der Linie perfekter Proportionalität, größere darunter
		- Erklärungen: größere Stabilität (kleine Parteien haben mehr zu verlieren) | mehr wichtige Ministerien für größere Parteien | mehr inhaltliche Gewinne (näher am Idealpunkt der Großen)

![[Screenshot from 2025-06-22 11-11-41.png|500]]
...
- Studien finden Proportionalität von ca. $0,6$
...
- 6% in parlamentarischen Systemen | 11% in premier-präsidentiellen | 21% in präsidentiell-parlamentarischen | 33% in präsidentiellen
