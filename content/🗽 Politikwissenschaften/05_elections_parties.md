...
- Fast immer wird nur ein wird nur ein Präsident gewählt (Ausnahme: BIH)
...
- Wenn im ersten Wahlgang niemand die absolute Mehrheit hat, gibt es einen zweiten Wahlgang mit den beiden Top-Kandidaten $\Rightarrow$ garantierte absolute Mehrheit in der Stichwahl
...
- Abwahl ist in präsidentiellen Systemen selten möglich und gelingt fast nie
	...
	- $\Rightarrow$ Preis der Direktwahl: auch sehr schlecht regierende oder korrupte Präsidenten wird man nicht leicht los

---
# Wie proportional werden Parlamente gewählt?
Zwei mögliche Anforderungen an Parlamentswahlen:
1. **Verhältniswahl:** So viele Parteien wie nötig, um die Konflikte abzubilden: Stimmen sollten proportional in Parlamentssitze übersetzt werden (z.B. 30% Stimmen $\to$ 30% Sitze)
...
## Verhältniswahl
*Niederlande*
- 15 Parlamentsparteien (gute Repräsentation, schwer Regierung zu bilden)
...
2. Benachteiligung bestimmter Parteien
	- historisch häufig linke Parteien betroffen (in innerstädtischen Wahlkreisen meist große Mehrheit $\Rightarrow$ verschwendete Stimmen über 50%)
	- Empirischer Befund: Rechte Regierungen sind in Mehrheitswahlsystemem häufiger an der Macht
3. Wahlkreinsmanipulation (*Gerrymandering*)
...
3. Stadt versus Land: Konflikt zwischen Agrar- und Industriesektor, vor allem um Freihandel versus Protektionismums
	- $\Rightarrow$ Agrar- und Bauernparteien, später dann Zentrumsparteien (z.B. finnische Zentrumspartei)
4. Arbeiter versus Arbeitgeber / Kapital: Konflikt um Staatsintervention, Sozialstaat, etc.
	- $\Rightarrow$ Arbeiterparteien, sozialistische und sozialdemokratische Parteien
...
- Werte zwischen 0 (vollständige Proportionalität) und 100 (vollständige Disproportionalität) | in der Realität ist schon 15 oder 20 hoch

$$G = \sqrt{\frac12 \sum(v_i - s_i)^2}$$
...
![[Screenshot from 2025-06-22 11-02-55.png|500]]

## Schluss
- Wahlsysteme sind für die Demokratie von fundamentaler Bedeutung
- Einfluss auf: Gewinner, Anzahl der Parteien
- Fragmentierte Parlamente sind Herausforderung (Regierungsbildung + Gesetzgebung), aber disproportionale Wahlsysteme sind auch mit Problemen und Gefahren verbunden $\Rightarrow$ **Balanceakt**
