...
- Erlaubt es einer Parlamentsmehrheit, die Regierung (im Prinzip) jederzeit abzuwählen $\Rightarrow$ demokratischer Charakter der Regierung
...
- Hintergrund: Seit längerem Kritik an Wahlen, da diese zu Ungleichheiten führen (Geld, Bildung, Netzwerke, Aussehen, etc.) $\Rightarrow$ Losen möglicherweise fairer
...
- **Idee:** eine Kammer wird gewählt, die andere gelost $\to$ ähnliche Balancierung wie bei Mehrheits- und Verhältniswahl
