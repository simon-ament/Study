---
title: Ideen und Märkte
---
# Business-Ideen
## Inspiration
1. Eine **Idee**, **Technologie** oder **Leidenschaft**
	- Neue Technologien findet man in z.B. in wissenschaftlichen Papers
2. Ask yourself: What can I do well, with **passion**, **curiosity** and **persistence**, that I would love to do for an **extended period of time**?
3. Man muss keine Erfahrung / Fähigkeiten in dem Thema haben, es reicht wenn man Experten auf dem Gebiet finden kann
4. Das gewählte Thema / die gewählte Nische sollte eine **große Nachfrage** haben $\Rightarrow$ **Finanzierung**
...
- **Orientierung am Investment-Verhalten**
	...
	- $\Rightarrow$ hohes Wachstumspotential, der Markt wurde zuvor durch Investoren validiert (*market research*, ggf. auch mithilfe von KI) 
- Ebenfalls sehr gut:
	- langweilige Bereiche $\Rightarrow$ keine große Anziehungskraft auf andere (Talente)
	- hohe Einstiegshürden (finanziell. technisch, regulatorisch, etc.) $\Rightarrow$ andere Gründer meiden diese Gebiete
	- hohe Konkurrenz $\Rightarrow$ Zeichen, dass ein Problem existiert und gelöst werden muss, ggf. Vorteil durch neuen Ansatz möglich
...
- Übersichtliche Kategorisierung von Themen, die für unsere Gesellschaft und unseren Planeten essenziell sind $\Rightarrow$ starkes **Warum**
- Investoren fokussieren sich zunehmend in Richtung Nachhaltigkeit $\Rightarrow$ Basis für starke **Finanzierung**
...
- **Mehrwert** für den Kunden $\Rightarrow$ **Mehrwert** für das eigene Geschäft $\Rightarrow$ kontinuierlicher **Mehrwert** für die Kunden (**wichtiger Zirkel**)
...
**Brainstorming** über mögliche Marktsegemente $\Rightarrow$ Bewusstsein über verschiedene mögliche Kunden und Mehrwerte (*value creation*) $\Rightarrow$ **fundierte Entscheidung** minimiert Risiko für Geld- und Zeitverlust

**Auswahl des Marktsegments:**
1. Sind die Zielkunden finanziell gut aufgestellt?
2. Sind die Zielkunden z.B. für Werbung und Vertrieb erreichbar?
3. Haben die Zielkunden ein ausreichendes Kaufbedürfnis / -grund?
4. Ist das Produkt bereits heute zur Auslieferung in dieses Marktsegement bereit?
5. Gibt es Wettbewerber, die im Wege stehen könnten?
6. Kann das Segment als Sprungbrett in andere Marktsegmente wirken?
7. Ist das Marktsegment konsistent mit den eigenen Werten, Begeisterungen und Zielen?
...
- mehrere Märkte können eine gute Wahl sein $\Rightarrow$ nicht über-optimieren
- Kriterien für Marktsegmente anwendbar
- große Lernerfahrung $\Rightarrow$ schnell und klein beginnen und testen, große Märkte meiden
...
1. **Endnutzer:** Die reale Person, die das Produkt tatsächlich nutzen wird
	- zumeist Teil der DMU
2. **Decision-making unit (DMU):** Die Gruppe der Stakeholder, die an der Kaufentscheidung beteiligt sind. Meistens:
...
9. Bücher, Webseiten, soziale Medien
10. Kaufgründe
11. Was zeichnet diese Person aus?
...
1. Wichtigste **Probleme und Motivation** der fokussierten **Kundengruppe** bestimmen
2. **Einzigartigen Mehrwert** (*value*) definieren, den das passende Produkt / der passende Service der Kundengruppe bietet
