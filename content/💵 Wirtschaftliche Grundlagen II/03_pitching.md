...
- angepasst an **Ziel** und **Zuhörerschaft** $\Rightarrow$ keine Universalgeschichte, sondern **individuell zugeschnitten**
- im Mittelpunkt des Pitches stehen die **Adressaten**, bei denen etwas bewirkt werden soll $\Rightarrow$ genaues **Verständnis** der Adressaten ist essenziell
...
- **Visuelle Elemente** können die Geschichte unterstützen, sollen aber **nicht** von ihr **ablenken**
	...
	- $\Rightarrow$ wenig Text auf Folien
...
- Dinge sollten **nicht zu genau**, sondern lieber **verständlich** vorgetragen werden $\Rightarrow$ Adressaten haben das Gefühl, alles verstanden zu haben (Details folgen in Gesprächen oder Schriftform)
- **Übung macht den Meister:** oft üben, vor verschiedenen Zuhörern, auch ohne Folien, Zuhörer Inhalte wiedergeben lassen, auf Stuhl stellen und Menschenmenge vorstellen, Situation simulieren (Zuschauerzahl, technische Begebenheiten, Podium, etc.) $\Rightarrow$ beim Vortrag **wohlfühlen**
...
![[Screenshot from 2024-08-05 19-59-30.png]]

**Lehren für einen Pitch:**
- mit dem Zweck / Ziel (**Why**) beginnen
- das Erzählen einer Geschichte baut emotionale Verbindung auf $\Rightarrow$ "Why" wird besser verstanden und behalten
...
- **Einfachheit** ist oft viel eingängiger als komplexe Mittel
	...
	- gerade bei komplexen Themen, ist es zunächst wichtig, dass das Gegenüber *glaubt*, alles verstanden zu haben $\Rightarrow$ **simplifizieren** (nicht falsch, aber kurz)
...
1. **Problem**
	...
	- **Methoden:** Adressaten zum Teil der Problem-Geschichte machen, fiktive Person verwenden, Zahlen / Statistiken (mit Quelle!) $\Rightarrow$ Dimension des Problems
...
3. **Potential / Impact**
	- Lösung sollte nicht nur Problem lösen, sondern die Welt besser machen $\Rightarrow$ welchen **[[05_digital_products_innovation#Impact|Impact]]** hat die Lösung?
